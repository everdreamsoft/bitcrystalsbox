...
var iconpathicon = chrome.extension.getURL('asset/img/icon-crystalbox-48.png');
var iconpathblue = chrome.extension.getURL('asset/img/paywithpockets-blue.png');
var iconpathyellow = chrome.extension.getURL('asset/img/paywithpockets-yellow.png');
var iconpathgreen = chrome.extension.getURL('asset/img/paywithpockets-green.png');
...
$('.pockets-payment-button').each(function(i, obj) {
    ...
    if (buttoncolor == "yellow") {
        ...
        var iconwidth = 160;
        iconpath = chrome.extension.getURL('asset/imgpaywithpockets-'+iconcolor+'.png');
    } else if (buttoncolor == "green") {
        var iconcolor = "green";
        var iconwidth = 160;
        iconpath = chrome.extension.getURL('asset/img/paywithpockets-'+iconcolor+'.png');
    } else if (buttoncolor == "icon") {
        var iconcolor = "icon";
        var iconwidth = 24;
        iconpath = chrome.extension.getURL('asset/img/icon-crystalbox-48.png');    
    } else {
        var iconcolor = "blue";
        var iconwidth = 160;
        iconpath = chrome.extension.getURL('asset/img/paywithpockets-'+iconcolor+'.png');
