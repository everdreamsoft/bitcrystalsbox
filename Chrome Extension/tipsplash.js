...
function getExtStorage()
{
    chrome.storage.local.get(["passphrase", "encrypted", "firstopen"], function (data)
    {
        if ( data.firstopen == false ) {
            ...
            $("#tipsendcomplete").html("<div align='center'><div style='padding: 50px 0 30px 0; font-size: 18px; width: 480px;'>Click on the BitCrystals Box Wallet icon to the right of your browser address bar to set up your wallet.</div><div><img src='setupss.png'></div></div>");
